...
{
    /// <summary>
    /// Orchestrator for getting all products
    /// </summary>
    public class GetAllProductsOrchestrator : IOrchestrator<object?, IEnumerable<ProductDto>>
    {
        private readonly IUnitOfWork _unitOfWork;

        public GetAllProductsOrchestrator(IUnitOfWork unitOfWork)
        {
        ...
        public async Task<OrchestratorResult<IEnumerable<ProductDto>>> ExecuteAsync(object? input)
        {
            ...
            {
                return OrchestratorResult<IEnumerable<ProductDto>>.FailureResult($"Failed to get products: {ex.Message}");
            }
        }
